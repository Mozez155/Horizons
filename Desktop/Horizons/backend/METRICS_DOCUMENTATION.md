...
The Horizons backend now exposes application performance and health metrics through a dedicated `/metrics` endpoint. This endpoint is compatible with industry-standard monitoring tools like Prometheus and Grafana, enabling real-time visibility into application performance.
...
Part of Horizons project - see main LICENSE file
