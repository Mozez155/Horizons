...
async function bootstrap() {
  ...
  const swaggerConfig = new DocumentBuilder()
    .setTitle('Horizons API')
    .setDescription(
      'Comprehensive API documentation for Horizons - A decentralized crypto news aggregator and portfolio management platform built on Stellar blockchain',
    )
    .setVersion('1.0')
    .addBearerAuth(
      {
    ...
    .addServer('https://api.horizons.io', 'Production')
    .build();
