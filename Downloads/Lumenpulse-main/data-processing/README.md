# Horizons Data Processing Service

This service handles compute-heavy tasks such as sentiment analysis and market trend prediction for the Horizons project.
...
bot = AlertBot()
bot.send_alert("🧪 Test: Hello World from Horizons!")
```
