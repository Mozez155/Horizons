...
Horizons Mobile is the cross-platform mobile client for the Horizons ecosystem, built with Expo and TypeScript. It provides real-time crypto news aggregation and portfolio tracking on the go.
